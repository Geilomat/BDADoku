Following in this chapter are the test that were taken to gain insight of the different system models and their performances.
...
Especially the first second under right corner and the last five seconds upper right corner are interesting.
...
This shows that it performance as good as a system which uses acceleration offset as a state value.
...
In the table \ref{tab:ErrorPointMassPitchAngle} the errors of the estimation can be seen once again.
...
%the effect of the pressure as a state variable is also to risky to really use it.
...
% Insert here figure of the best system which perform with and without GPS and different offsets ond acceleration as well different errors in Tgrad
